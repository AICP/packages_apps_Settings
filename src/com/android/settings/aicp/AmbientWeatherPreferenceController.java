...
public class AmbientWeatherPreferenceController extends AbstractPreferenceController implements
    ...
    public void updateState(Preference preference) {
        int value = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.AMBIENT_WEATHER_LOCKSCREEN, 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.Secure.putInt(mContext.getContentResolver(),
                Settings.Secure.AMBIENT_WEATHER_LOCKSCREEN, enabled ? 1 : 0);
        return true;
    }
}
