...
public class ProgressBar extends SettingsPreferenceFragment implements
    ...
    private SeekBarPreferenceCham mprogressbar_speed;
    private SeekBarPreferenceCham mprogressbar_width;
    private SeekBarPreferenceCham mprogressbar_length;
    private SeekBarPreferenceCham mprogressbar_count;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbar_reverse.setChecked(Settings.System.getInt(getContentResolver(),
                Settings.System.PROGRESSBAR_REVERSE, 0) == 1);

        mprogressbar_speed = (SeekBarPreferenceCham) findPreference(PROGRESSBAR_SPEED);
        ...
        mprogressbar_width = (SeekBarPreferenceCham) findPreference(PROGRESSBAR_WIDTH);
        ...
        mprogressbar_length = (SeekBarPreferenceCham) findPreference(PROGRESSBAR_LENGTH);
        ...
        mprogressbar_count = (SeekBarPreferenceCham) findPreference(PROGRESSBAR_COUNT);
