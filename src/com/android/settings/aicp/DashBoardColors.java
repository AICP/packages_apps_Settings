...
public class DashBoardColors extends SettingsPreferenceFragment  implements Preference.OnPreferenceChangeListener ,Indexable {
 ...
 private static final int DASHBOARD_TEXT_DEFAULT = 0xFF000000;
 private static final int DASHBOARD_ICON_DEFAULT = 0xFFC0C0C0;
 ...
 @Override
    public void onCreate(Bundle icicle) {
        ...
        intColor = Settings.System.getInt(getContentResolver(),
                    Settings.System.DASHBOARD_ICON_COLOR, DASHBOARD_ICON_DEFAULT);
        hexColor = String.format("#%08x", (0xFFC0C0C0 & intColor));
        ...
        intColor = Settings.System.getInt(getContentResolver(),
                    Settings.System.DASHBOARD_TEXT_COLOR, DASHBOARD_TEXT_DEFAULT);
	...
	Resources res = getResources();
	  if (preference == mIconColor) {
            ...
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
                    Settings.System.DASHBOARD_ICON_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
                    Settings.System.DASHBOARD_TEXT_COLOR, intHex);
            return true;
         }
	return false;
	}
    ...
    private void resetValues() {
        Settings.System.putInt(getContentResolver(),
                Settings.System.DASHBOARD_ICON_COLOR, DASHBOARD_ICON_DEFAULT);
        mIconColor.setNewPreviewColor(DASHBOARD_ICON_DEFAULT);
        mIconColor.setSummary(R.string.default_string);
        Settings.System.putInt(getContentResolver(),
                Settings.System.DASHBOARD_TEXT_COLOR, DASHBOARD_TEXT_DEFAULT);
        mTextColor.setNewPreviewColor(DASHBOARD_TEXT_DEFAULT);
