...
public class IntervalSeekBar extends SeekBar {
    ...
    public IntervalSeekBar(Context context, AttributeSet attrs) {
        ...
        mMax = seekBarType.getFloat(R.styleable.IntervalSeekBar_isbMax, 1.5f);
        mMin = seekBarType.getFloat(R.styleable.IntervalSeekBar_isbMin, 0.5f);
        mDefault = seekBarType.getFloat(R.styleable.IntervalSeekBar_isbDefaultValue, 1.0f);

        int digits = seekBarType.getInt(R.styleable.IntervalSeekBar_isbDigits, 0);
