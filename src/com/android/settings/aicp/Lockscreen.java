...
public class Lockscreen extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isPhone(getActivity())) {
            int lockscreenTargetsNumber = Settings.System.getInt(resolver,
                    Settings.System.LOCKSCREEN_TARGETS_NUMBER, 1);
    ...
    private void updateLockscreenTargetsSummary(int i) {
        if (i == 1) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_1);
        } else if (i == 2) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_2);
        } else if (i == 3) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_3);
        } else if (i == 4) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_4);
        } else if (i == 5) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_5);
        } else if (i == 6) {
            mLockscreenTargetsNumber.setSummary(R.string.lockscreen_targets_number_6);
        } else if (i == 7) {
