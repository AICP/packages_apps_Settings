/*
 * Copyright (C) 2016 The Android Ice Cold Project
 *
...
public class AicpExtras extends SettingsPreferenceFragment implements ActionBar.TabListener {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.aicpextras_settings);
        getActivity().setTheme(R.style.aicp_extras);
        if (view == null) {
            view = inflater.inflate(R.layout.activity_aicp_settings, container, false);
