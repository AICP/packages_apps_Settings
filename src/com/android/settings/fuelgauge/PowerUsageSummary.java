...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    private String getPrefResources(String prefKey, boolean returnPath) {
        switch (prefKey) {
            case KEY_DESIGNED_BATTERY_CAPACITY:
                return returnPath ? getResources().getString(R.string.config_batDesCap)
                                  : parseInteger(getResources().getString(R.string.config_batDesCap)) /
                                      Integer.parseInt(getResources().getInteger(R.integer.config_batDesCapDivider)) + " mAh";
            case KEY_CURRENT_BATTERY_CAPACITY:
                return returnPath ? getResources().getString(R.string.config_batCurCap)
                                  : parseInteger(getResources().getString(R.string.config_batCurCap)) /
                                      Integer.parseInt(getResources().getInteger(R.integer.config_batCurCapDivider)) + " mAh";
            case KEY_BATTERY_CHARGE_CYCLES:
                return returnPath ? getResources().getString(R.string.config_batChargeCycle)
                                  : parseInteger(getResources().getString(R.string.config_batChargeCycle)) + " Cycles";
            case KEY_BATTERY_TYPE:
                return returnPath ? getResources().getString(R.string.config_batType)
                                  : parseLine(getResources().getString(R.string.config_batType));
            case KEY_BATTERY_HEALTH:
                return returnPath ? getResources().getString(R.string.config_batHealth)
                                  : parseInteger(getResources().getString(R.string.config_batHealth)) + " %";
        }
        return null;
    }
