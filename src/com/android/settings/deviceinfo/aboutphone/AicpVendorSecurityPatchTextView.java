...
public class AicpVendorSecurityPatchTextView extends TextView {
    private static final String TAG = "AicpVendorSecurityPatchTextView";
    ...
    public AicpVendorSecurityPatchTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
