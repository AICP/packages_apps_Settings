...
public class SmsCallController {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.QUIET_HOURS_START),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.AOKP.getUriFor(
                    Settings.AOKP.QUIET_HOURS_END),
                    false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            mQuietHoursEnabled = Settings.AOKP.getIntForUser(mContext.getContentResolver(),
                    Settings.AOKP.QUIET_HOURS_ENABLED, 0,
                    UserHandle.USER_CURRENT_OR_SELF) != 0;
            mQuietHoursStart = Settings.AOKP.getIntForUser(mContext.getContentResolver(),
                    Settings.AOKP.QUIET_HOURS_START, 0,
                    UserHandle.USER_CURRENT_OR_SELF);
            mQuietHoursEnd = Settings.AOKP.getIntForUser(mContext.getContentResolver(),
