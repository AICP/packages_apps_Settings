 ...
 */
abstract class AppListFragment: Fragment(R.layout.applock_app_list_layout), MenuItem.OnActionExpandListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.applock_app_list_menu, menu)
            ...
            ListAdapter<AppInfo, AppListViewHolder>(itemCallback)
    {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            AppListViewHolder(layoutInflater.inflate(
                R.layout.applock_app_list_item, parent, false))
