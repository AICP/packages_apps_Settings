...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        kernelPref.setSummary(DeviceInfoUtils.customizeFormatKernelVersion(
    ...
    private String getMemInfo() {
        String result = null;
        FileReader fileReader = new FileReader(new File(FILENAME_PROC_MEMINFO));
    ...
    private String getCPUInfo() {
        String result = null;
        FileReader fileReader = new FileReader(new File(FILENAME_PROC_CPUINFO));
        BufferedReader reader = new BufferedReader(fileReader);
        try {
