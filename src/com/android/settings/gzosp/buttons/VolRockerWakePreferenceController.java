...
public class VolRockerWakePreferenceController extends AbstractPreferenceController implements
    ...
    public VolRockerWakePreferenceController(Context context, String key) {
        super(context);
        mContext = context;
        mKey = key;
    ...
    public void updateState(Preference preference) {
        boolean defaultBehavior = (mDeviceHardwareWakeKeys & KEY_MASK_VOLUME) != 0;
        int setting = Settings.System.getInt(mContext.getContentResolver(),
                VOLUME_WAKE_SCREEN, defaultBehavior ? 1 : 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), VOLUME_WAKE_SCREEN,
                enabled ? 1 : 0);
        return true;
    }
}
