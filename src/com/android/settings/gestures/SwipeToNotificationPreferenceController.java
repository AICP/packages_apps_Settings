...
public class SwipeToNotificationPreferenceController extends BasePreferenceController
    ...
    public void onCreate(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            mAnimationPaused = savedInstanceState.getBoolean(KEY_VIDEO_PAUSED, false);
        }
    }

     @Override
    public void onSaveInstanceState(Bundle outState) {
        outState.putBoolean(KEY_VIDEO_PAUSED, mAnimationPaused);
    }

    @Override
    public void onPause() {
        if (mVideoPreference != null) {
            mAnimationPaused = mVideoPreference.isAnimationAvailable();
    ...
    public void onResume() {
        if (mVideoPreference != null) {
            if (mAnimationPaused) mVideoPreference.onViewVisible();
        }
    }
